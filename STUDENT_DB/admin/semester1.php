...
?>
  ...
  if(isset($_POST['Submitsem1m']))
  {
    ...
    $sqlStr="insert into info(roll_no,physics,chemistry,maths1,eng_mech,workshop,cprog,cprog_lab,eng_draw) values('$roll_no','$physics','$chemistry','$maths1','$eng_mech','$workshop','$cprog','$cprog_lab','$eng_draw')";
      @mysql_query($sqlStr);
      $query="select * from semester1 where roll_num='$roll_no'";
